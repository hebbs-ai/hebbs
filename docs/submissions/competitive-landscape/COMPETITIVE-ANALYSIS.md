...
| Portable cognition (`.hebbs/` as self-contained, shareable, rebuildable cognition artifact) | **YES** | None | Unique |
| Privacy-by-design (`.hebbsignore` selective indexing) | **YES** | None | Unique |
